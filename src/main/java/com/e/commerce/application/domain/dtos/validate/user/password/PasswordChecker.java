...
public class PasswordChecker implements ConstraintValidator<ValidPassword, String> {
    private static final int MIN_LENGTH = 6;
    private static final int MAX_LENGTH = 32;
    private static final String SIZE_VALID_MESSAGE = "{inValidPassword.size}";
    private static final String CONTENT_VALID_MESSAGE = "{inValidPassword.content}";
